...
// We also need the strategy defined by our 'passport-local' module....in this case it will be email login only for MVP. 
...
// Since we will be using the userProfile model to control access and
